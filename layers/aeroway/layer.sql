...
RETURNS TABLE(geometry geometry, class text, ref text, start_date text, end_date text) AS $$
    SELECT geometry, aeroway AS class, ref, start_date, end_date FROM (
        -- etldoc:  osm_aeroway_linestring_gen3 -> layer_aeroway:z10
        SELECT geometry, aeroway, ref, start_date, end_date
