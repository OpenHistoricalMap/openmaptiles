...
CREATE OR REPLACE VIEW water_z0 AS (
    ...
    SELECT NULL::bigint AS osm_id, geometry, 'ocean'::text AS class, ''::text AS name, ''::text AS start_date, ''::text AS end_date FROM ne_110m_ocean
    UNION ALL
    -- etldoc:  ne_110m_lakes ->  water_z0
    SELECT NULL::bigint AS osm_id, geometry, 'lake'::text AS class, name, ''::text AS start_date, ''::text AS end_date FROM ne_110m_lakes
);
...
CREATE OR REPLACE VIEW water_z2 AS (
    ...
    SELECT NULL::bigint AS osm_id, geometry, 'ocean'::text AS class, ''::text AS name, ''::text AS start_date, ''::text AS end_date FROM ne_50m_ocean
    UNION ALL
    -- etldoc:  ne_50m_lakes ->  water_z2
    SELECT NULL::bigint AS osm_id, geometry, 'lake'::text AS class, name, ''::text AS start_date, ''::text AS end_date FROM ne_50m_lakes
);
...
CREATE OR REPLACE VIEW water_z5 AS (
    ...
    SELECT NULL::bigint AS osm_id, geometry, 'ocean'::text AS class, ''::text AS name, ''::text AS start_date, ''::text AS end_date FROM ne_10m_ocean
    UNION ALL
...
CREATE OR REPLACE VIEW water_z8 AS (
    ...
    SELECT NULL::bigint AS osm_id, geometry, 'ocean'::text AS class, ''::text AS name, ''::text AS start_date, ''::text AS end_date FROM osm_ocean_polygon_gen4
    UNION ALL
...
CREATE OR REPLACE VIEW water_z9 AS (
    ...
    SELECT NULL::bigint AS osm_id, geometry, 'ocean'::text AS class, ''::text AS name, ''::text AS start_date, ''::text AS end_date FROM osm_ocean_polygon_gen3
    UNION ALL
...
CREATE OR REPLACE VIEW water_z10 AS (
    ...
    SELECT NULL::bigint AS osm_id, geometry, 'ocean'::text AS class, ''::text AS name, ''::text AS start_date, ''::text AS end_date FROM osm_ocean_polygon_gen2
    UNION ALL
...
CREATE OR REPLACE VIEW water_z11 AS (
    ...
    SELECT NULL::bigint AS osm_id, geometry, 'ocean'::text AS class, ''::text AS name, ''::text AS start_date, ''::text AS end_date FROM osm_ocean_polygon_gen1
    UNION ALL
...
CREATE OR REPLACE VIEW water_z12 AS (
    ...
    SELECT NULL::bigint AS osm_id, geometry, 'ocean'::text AS class, ''::text AS name, ''::text AS start_date, ''::text AS end_date FROM osm_ocean_polygon
    UNION ALL
...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, name text, start_date text, end_date text) AS $$
    SELECT osm_id, geometry, class::text, name::text, start_date::text, end_date::text FROM (
...
CREATE MATERIALIZED VIEW osm_important_waterway_linestring AS (
    SELECT
        ...
        name, name_en, name_de, tags, start_date, end_date
    FROM (
        SELECT
            osm_id,
        ...
        GROUP BY osm_id, name, name_en, name_de, slice_language_tags(tags), start_date, end_date
    ) AS waterway_union
);
...
CREATE MATERIALIZED VIEW osm_important_waterway_linestring_gen1 AS (
    SELECT osm_id, ST_Simplify(geometry, 60) AS geometry, name, name_en, name_de, tags, start_date, end_date
...
CREATE MATERIALIZED VIEW osm_important_waterway_linestring_gen2 AS (
    SELECT osm_id, ST_Simplify(geometry, 100) AS geometry, name, name_en, name_de, tags, start_date, end_date
...
CREATE MATERIALIZED VIEW osm_important_waterway_linestring_gen3 AS (
    SELECT osm_id, ST_Simplify(geometry, 200) AS geometry, name, name_en, name_de, tags, start_date, end_date
...
CREATE OR REPLACE VIEW waterway_z12 AS (
    SELECT osm_id, geometry, waterway::text AS class, name, name_en, name_de, tags, is_bridge, is_tunnel, start_date, end_date
    FROM osm_waterway_linestring
...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, name text, name_en text, name_de text, brunnel text, start_date text, end_date text, tags hstore) AS $$
    ...
    WHERE geometry && bbox;
$$ LANGUAGE SQL IMMUTABLE;
DO $$ BEGIN RAISE NOTICE 'Layer landcover'; END$$;-- OHM note: these include NaturalEarth content which is not Historical
-- the question is pending, whether incluing non-OHM data is appropriate - GDA 2018-July
...
CREATE OR REPLACE VIEW landuse_z4 AS (
    SELECT osm_id, geometry, landuse, amenity, leisure, tourism, start_date, end_date
...
$$ LANGUAGE SQL IMMUTABLE;
DO $$ BEGIN RAISE NOTICE 'Layer park'; END$$;-- OHM note: the source layer osm_park_polygon lacks a name; just landuse and leisure
...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, start_date text, end_date text) AS $$
    SELECT osm_id, geometry,
        ...
        SELECT osm_id, geometry, leisure, boundary, NULL::int as scalerank, start_date, end_date
...
$$ LANGUAGE SQL IMMUTABLE;
DO $$ BEGIN RAISE NOTICE 'Layer aeroway'; END$$;-- OHM note: both of the source layers here osm_aeroway_linestring and osm_aeroway_polygon
-- lack a name field. so we can't show labels.  - GDA 218 July
...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, ref text, start_date text, end_date text) AS $$
    SELECT osm_id, geometry, aeroway AS class, ref, start_date, end_date FROM (
        -- etldoc:  osm_aeroway_linestring_gen3 -> layer_aeroway:z10
        SELECT osm_id, geometry, aeroway, ref, start_date, end_date
...
CREATE MATERIALIZED VIEW osm_transportation_merge_linestring AS (
    ...
    FROM (
      ...
      group by highway, name, name_en, name_de, start_date, end_date
    ) AS highway_union
);
...
CREATE MATERIALIZED VIEW osm_transportation_merge_linestring_gen3 AS (
    SELECT ST_Simplify(geometry, 120) AS geometry, osm_id, highway, name, name_en, name_de, start_date, end_date, z_order
...
CREATE MATERIALIZED VIEW osm_transportation_merge_linestring_gen4 AS (
    SELECT ST_Simplify(geometry, 200) AS geometry, osm_id, highway, name, name_en, name_de, start_date, end_date, z_order
...
CREATE MATERIALIZED VIEW osm_transportation_merge_linestring_gen5 AS (
    SELECT ST_Simplify(geometry, 500) AS geometry, osm_id, highway, name, name_en, name_de, start_date, end_date, z_order
...
CREATE MATERIALIZED VIEW osm_transportation_merge_linestring_gen6 AS (
    SELECT ST_Simplify(geometry, 1000) AS geometry, osm_id, highway, name, name_en, name_de, start_date, end_date, z_order
...
CREATE MATERIALIZED VIEW osm_transportation_merge_linestring_gen7 AS (
    SELECT ST_Simplify(geometry, 2000) AS geometry, osm_id, highway, name, name_en, name_de, start_date, end_date, z_order
...
RETURNS TABLE(osm_id bigint, geometry geometry, name text, name_en text, name_de text, class text, subclass text,
ramp int, oneway int, brunnel TEXT, service TEXT, layer INT, level INT,
indoor INT, start_date text, end_date text) AS $$
    SELECT
    ...
    FROM (
        ...
        SELECT
            osm_id, geometry, ''::text AS name, ''::text AS name_en, ''::text AS name_de,
            highway, NULL AS railway, NULL AS aerialway, NULL AS shipway,
...
$$ LANGUAGE SQL IMMUTABLE;
DO $$ BEGIN RAISE NOTICE 'Layer building'; END$$;-- OHM note: the OSM tables osm_building_relation osm_building_associatedstreet osm_building_street osm_building_polygon
...
RETURNS TABLE(osm_id bigint, geometry geometry, name text, name_en text, name_de text, tags hstore, class text, start_date text, end_date text) AS $$
...
CREATE MATERIALIZED VIEW osm_transportation_name_linestring AS (
    ...
    FROM (
      ...
      group by name, name_en, name_de, ref, highway, "level", layer, indoor, network_type, start_date, end_date
    ) AS highway_union
);
...
CREATE MATERIALIZED VIEW osm_transportation_name_linestring_gen1 AS (
    SELECT ST_Simplify(geometry, 50) AS geometry, osm_id, name, name_en, name_de, tags, ref, highway, network, start_date, end_date, z_order
...
CREATE MATERIALIZED VIEW osm_transportation_name_linestring_gen2 AS (
    SELECT ST_Simplify(geometry, 120) AS geometry, osm_id, name, name_en, name_de, tags, ref, highway, network, start_date, end_date, z_order
...
CREATE MATERIALIZED VIEW osm_transportation_name_linestring_gen3 AS (
    SELECT ST_Simplify(geometry, 200) AS geometry, osm_id, name, name_en, name_de, tags, ref, highway, network, start_date, end_date, z_order
...
CREATE MATERIALIZED VIEW osm_transportation_name_linestring_gen4 AS (
    SELECT ST_Simplify(geometry, 500) AS geometry, osm_id, name, name_en, name_de, tags, ref, highway, network, start_date, end_date, z_order
...
RETURNS TABLE(osm_id bigint, geometry geometry, name text, name_en text, name_de text,
    tags hstore, place city_place, "rank" int, capital int, start_date text, end_date text) AS $$
    SELECT osm_id, geometry, name,
        COALESCE(NULLIF(name_en, ''), name) AS name_en,
        COALESCE(NULLIF(name_de, ''), name, name_en) AS name_de,
        tags,
...
RETURNS TABLE(osm_id bigint, geometry geometry, name text, name_en text,
    name_de text, tags hstore, class text, "rank" int, capital INT, iso_a2 TEXT,
    start_date text, end_date text) AS $$
